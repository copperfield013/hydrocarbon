...
<link rel="stylesheet" href="media/admin/treeview/css/treeview.css">
...
<script src="media/admin/treeview/js/treeview.js"></script>
...
<div id="tree_view_panel">
	...
	<!-- <div class="">
		<label for="attr-count">显示属性的个数：</label>
		<input type="text" id="attr-count" />
	</div> -->
	<div class="entity-edit-wrap active">
		<!-- 实体标题:begin -->
      	<div class="entity-title collapse-header al-save need-ajax" data-mappingName="${mappingName }" data-abcattrCode="${resultList[0] }" data-order="${btNode.order}" data-id="${resultList[0] }">
            ...
            <%-- <input name="name" disabled type="text" class="edit-input" value="${resultList[1] }"> --%>
            <span class="entity-only-title">${btNode.basicItem.cnName}</span>
            <div class="btn-wrap">
            	<i class="icon icon-save"></i>
                <i class="icon icon-add"></i>
                <a title="编辑" class="tree-node-edit-btn" style="font-size: 14px;position:absolute;right:130px;" href="javascript:;">编辑</a>
        ...
        <!-- 拖拽排序wrap -->
        <ul class="dragEdit-wrap dragEdit-wrap-1 collapse-content  collapse-content-active  need-ajax" id="dragEdit-1">
            <!-- 属性-->
